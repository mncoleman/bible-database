...
const CanvasWrapper: FC<{ children: ReactNode; alpha?: boolean }> = ({ children, alpha }) => (
  <Canvas dpr={[1, 2]} frameloop="always" className="w-full h-full relative" gl={alpha ? { alpha: true } : undefined}>
    {children}
  </Canvas>
);
...
const Beams: FC<BeamsProps> = ({
  ...
  return (
    <CanvasWrapper alpha={isTransparent}>
